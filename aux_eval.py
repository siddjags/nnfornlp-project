...
# Load test set and emoji embeddings
test_dataframe = pd.read_csv('preprocessing/test_cleaned_new.csv')
test_embedding = np.load('preprocessing/test_emoji.npy')

# Defamation
inference = evaluator(test_dataframe,"bert-base-multilingual-uncased",'models/al-uncased_defamation_aux_model.pt','defamation',test_embedding)
inference.generate_f1()

# Fake
inference = evaluator(test_dataframe,"bert-base-multilingual-uncased",'models/al-uncased_fake_aux_model.pt','fake',test_embedding)
inference.generate_f1()

# Hate
inference = evaluator(test_dataframe,"bert-base-multilingual-uncased",'models/al-uncased_hate_aux_model.pt','hate',test_embedding)
inference.generate_f1()

# Offensive
inference = evaluator(test_dataframe,"bert-base-multilingual-uncased",'models/al-uncased_offensive_aux_model.pt','offensive',test_embedding)
inference.generate_f1()