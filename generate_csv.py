...
model_path = ["./models/"+ model +"_non-hostile_model_f1_aux.pt",
              "./models/"+ model +"_fake_model_f1_aux.pt",
              "./models/"+model +"_defamation_model_f1_aux.pt",
              "./models/" + model+"_hate_model_f1_aux.pt",
              "./models/"+model+"_offensive_model_f1_aux.pt"]
